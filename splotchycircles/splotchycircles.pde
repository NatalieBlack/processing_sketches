...
color[] fourth = {color(#E8507E), color(#F7A3BC), color(#EF749A), color(#DC2F64), color(#BB0F43)};
  ...
  for(int k = 0; k < circlenum; k++){
    fill(primary[(int(random(4)))],10);

  ellipse(random(640/2),random(360/2),circlesize, circlesize);
  }
  for(int k = circlenum; k < circlenum*2; k++){
    fill(secondary[int(random(4))],10);

      ellipse(random(640/2, 640),random(360/2),circlesize, circlesize);
  }
  for(int k = circlenum*2; k < circlenum*3; k++){
    fill(tertiary[int(random(4))],10);

      ellipse(random(640/2, 640),random(360/2, 360),circlesize, circlesize);
  }
  for(int k = circlenum*3; k < circlenum*4; k++){
    fill(fourth[int(random(4))],10);

      ellipse(random(640/2),random(360/2, 360),circlesize, circlesize);
  }
}
