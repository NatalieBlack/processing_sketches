...
void sketchyCircle(int x1, int y1){
  ...
  beginShape();
  vertex(x1,y1);
  bezierVertex(WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w, WINDOWSIZE-w);
  bezierVertex(w, w, w, w, w, w);
  endShape();
  beginShape();
  vertex(x1,y1);
  bezierVertex(w, WINDOWSIZE-w, w, WINDOWSIZE-w, w, WINDOWSIZE-w);
  bezierVertex(WINDOWSIZE-w, w,WINDOWSIZE- w, w, WINDOWSIZE-w, w);
  endShape();
}
